package it.project.authentication;
...
public class AuthConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .requestMatchers(HttpMethod.GET, "/", "/index", "/register", "/css/**", "/images/**", "/favicon.ico","/demo","/recensione/**","/fiori/**","/servizi/**","/gatti/**","/piante/**","/recensioni/**","/accessori/**","/fiore/**","/servizio/**","/gatto/**","/recensione/**","/accessorio/**","/mazzo/**","/mazzi/**").permitAll()  // Permette l'accesso pubblico a specifici URL
