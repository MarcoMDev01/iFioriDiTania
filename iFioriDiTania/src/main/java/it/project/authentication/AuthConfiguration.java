...
public class AuthConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
            ...
            .requestMatchers(HttpMethod.GET, "/", "/index", "/register", "/css/**", "/images/**", "/favicon.ico","/demo","/recensione/**","/fiori/**","/servizi/**","/gatti/**","/recensioni/**","/accessori/**").permitAll()  // Permette l'accesso pubblico a specifici URL
